...
EVAPORATION2_A						   = _read_data('evaporation2.data', value_col=1)
EVAPORATION2_B						   = _read_data('evaporation2.data', value_col=2)
SIMPOL_1                               = _read_data('SIMPOL.data', value_col=1)
SIMPOL_2                               = _read_data('SIMPOL.data', value_col=2)
SIMPOL_3                               = _read_data('SIMPOL.data', value_col=3)
SIMPOL_4                               = _read_data('SIMPOL.data', value_col=4)
...
EVAPORATION2_SMARTS                    = _read_smarts('evaporation2.smarts')
SIMPOL_SMARTS                          = _read_smarts('SIMPOL.smarts')
