...
def handler(
    ...
    """
    Calculates the CCN activation potential of an organic mixture from a
    ...
    * 'joback_and_reid'
    ...
    for temperature in temperatures:
        ...
        for dry_size in dry_sizes:
            sat_ratio, Kappa, vp, coeffs = CCN_activation.growth_factor_model_org(
                 organic_compounds, pressure_data, density_data, temperature, ideality, dry_size, surface_tension)
