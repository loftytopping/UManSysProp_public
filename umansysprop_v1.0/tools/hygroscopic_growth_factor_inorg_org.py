...
def handler(
    ...
    *compounds* (given as a sequence of SMILES strings) at all given
    ...
    * 'joback_and_reid'
    ...
    for temperature in temperatures:
        ...
        for humidity in humidities:
            growth_factor, Kappa, water_activity, vp, coeffs, mass_frac_sol = hygroscopicity.growth_factor_model_inorg_org(
                organic_compounds, inorganic_ions, pressure_data, density_data, temperature, humidity, ideality, size_dependance)
